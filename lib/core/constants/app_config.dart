class AppConfig {
  ...
  static const String apiBackProducts = 'https://backend-products-143596276526.us-central1.run.app';
  static const String apiBackStores = 'https://backend-stores-143596276526.us-central1.run.app';
}